                ...
                <div class="box">
                    <div class="box-header">
                        <center>
                            <h2>Contact Us</h2>
                            <p class="text-muted">
                                If you have any questions, please fell free to contact us,our customer service is working for you 24/7.
                            </p>
                        </center>
                    </div>
                    <!-- form -->
                    <form action="contactus.php" method="post">
                        ...
                        <div class="text-center">
                            <button type="submit" name="submit" class="btn btn-primary"><i class="fa fa-user-md"></i>Send Massage</button>
                        </div>
