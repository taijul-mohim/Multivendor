...
<div class="row container">
        ...
        <!-- end -->
          <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                <textarea name="p_cat_desc" class="form-control" id="" cols="30" rows="10" required='' ></textarea>
                    </div>
    ...
    if(isset($_POST['submit'])){
        ...
        $query="INSERT INTO product_categories(p_cat_title,p_cat_desc)VALUES('$p_c_title','$p_c_desc')";
        $sqli=mysqli_query($con,$query);
        if($sqli){
            echo "<script>alert('product Category Add  successfully')</script>"  ;
